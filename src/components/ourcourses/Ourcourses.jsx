...
const Ourcourses = () => {
    ...
    return (
        <div className={classes.Ourcourses__background}>
            <h2 className={classes.Ourcourses__title}>Наши курсы</h2>
            <div className={classes.Ourcourses__div_courses}>
                <PrevButton onClick={goPrev} />
                <div className={classes.Ourcourses__slider}>
                    <div className={classes.Ourcourses__slider_line} style={{ left: -offset + "px" }}>
                        <Card cards={{
                            color: '#586EE1',
